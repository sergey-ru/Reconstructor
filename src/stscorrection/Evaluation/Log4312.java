 ...
 * @author sergei
 */
public class Log4312 extends AbsLogEvaluator {

    public Log4312() {
        super("C:\\Users\\sergeyru\\Downloads\\1\\Logfile_4312.CSV",
                "/home/sergei/Dropbox/~Modeling and Simulation of Advanced Persistent Threat/DarkCommet/Logs/Logfile_4312.CSV", "4312");
    }
    ...
    public double evaluateLog(ArrayList<ActionsPair> actionList) {
        String[] ref = new String[]{
            ...
            "FileManager SearchForFiles NotRecursive",
            "FileManager ExplorerFiles Open admin",
